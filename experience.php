...
//creating a CRUD functionality for the sports_experience table
//insert new data to sports_experience table
if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO sports_experience (question_number, survey_question, agree, disagree, prefer_not_to_say)
...
//edit data from sport_experiences table
if (isset($_GET['edit'])){ //if edit link is clicked
    $question_number = $_GET['edit'];
    $update = true;
    $query_edit = "SELECT  * FROM sports_experience WHERE question_number=$question_number";
...
//update data from sports_experience table
if (isset($_POST['update'])){
    ...
    $disagree = $_POST['disagree'];
    $prefer_not_to_say = $_POST['prefer_not_to_say'];
    $query_update = "UPDATE sports_experience SET survey_question='$survey_question', 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Sports Experience</h5>
