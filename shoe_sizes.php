...
if(isset($_POST['submit'])) {
    ...
    $"41_43" = $_POST["41_43"];
    $"44_46" = $_POST["44_46"];
    $"47_and_above" = $_POST["47_and_above"]
    
    if(!empty($survey_question) && !empty($"38_40") && !empty($"41_43") && !empty($"44_46") && !empty($"47_and_above")){
            
    $query = "INSERT INTO laces_laceless (question_number, survey_question, "38_40", "41_43", "44_46", "47_and_above")
    VALUES ('$question_number', '$survey_question', '$"38_40"', '$"41_43"', '$"44_46"', '$"47_and_above"')";
